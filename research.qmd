...
To answer these questions I am working across a suite of samples from small mammals, domestic animals, and people living and working across a fragmented landscape in rural northeastern Madagascar. Human land use alters the ecological communities --- including which and how many parasites and infected hosts live there --- thus altering patterns multi-host parasite sharing.

I use infection data and remotely sensed environmental data to build models of "landscape-level" risk of these various habitat types. Then use a combination of real and simulated human movement data to quantify exposure risk and test if that risk translates into a higher probability of infection.
